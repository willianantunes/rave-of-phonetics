...
from rave_of_phonetics.apps.twitter import api_views as twitter_views
...
# Something to worry about if this app scales out
...
urlpatterns = [
    ...
    path("twitter/auth/", twitter_views.auth, name="twitter-auth"),
    path("twitter/callback/", twitter_views.callback, name="twitter-callback"),
