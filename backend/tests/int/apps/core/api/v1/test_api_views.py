...
def test_should_return_400_given_no_body_is_sent(client):
    header = {
...
def test_should_return_401_token_is_fake_and_not_valid(client):
...
def test_should_receive_transcription(client, mocker):
    mocked_verify_user_response = mocker.patch("rave_of_phonetics.apps.core.api.v1.api_views.verify_user_response")
